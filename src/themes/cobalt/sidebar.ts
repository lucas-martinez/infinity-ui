...
import pick, { normalize } from '../pick';
...
const sidebarQuantumUX = {
  ...
  width: spec.global.sideMenu.widthOpen,

  minimized: {
    width: spec.global.sideMenu.widthMinimized,
  },
...
export const sidebar: SidebarTheme = deepMerge<any, any>({}, sidebarQuantumUX, sidebarHerculesUX);

const generator: PartialThemeGenerator<'sidebar'> = ({ baseSpacing = 24, scale = 6 }) => {
  return {
    sidebar,
  };
};
