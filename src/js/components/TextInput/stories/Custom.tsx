...
import { Box, Grommet, Image, Text, TextInput } from '../../../../js';
...
const CustomSuggestionsTextInput = () => {
  ...
  const [suggestionOpen, setSuggestionOpen] = useState<any>(false);
  const [suggestedFolks, setSuggestedFolks] = useState<any>([]);
